---
title: 서비스에 MCP 연결하기
date: 2026-08-14T07:00+09:00
description: 서비스 내 MCP 연결 기능 도입에 대한 고민을 다룹니다.
tags:
    - MCP
    - SaaS
    - AI
...
> [한전 에너지마켓플레이스](https://en-ter.co.kr/main.do) 동의 후 제공받을 수 있는 데이터로는 AI 분석 결과에 필요한 전력 데이터들이 부족하다고 볼 수 있어요.
...
- **[Exa 웹 검색 MCP](https://exa.ai/docs/reference/exa-mcp)**: AI 시맨틱 웹 검색 및 지식 추출
...
개인적으로는 서비스 내에 MCP 클라이언트 연결 기능을 무리하게 도입하기보다, 다른 서비스들처럼 사용자의 로컬 AI(Claude Desktop, Cursor 등)에 연결해 우리 서비스의 데이터와 기능을 활용할 수 있는 **서비스 전용 MCP 서버**를 제공하는 것이 훨씬 적합한 방향이라고 생각이 들기도 합니다.
